...
def database_create(data):
    ...
    try:
        ...
        db.updateDBfile(data, "data/v1_createDB.sql", False)
    except Exception as e:
        # En cas d'erreur, on affiche un message
        print("L'erreur suivante s'est produite pendant lors de la création de la base : " + repr(e) + ".")

    try:
        # On exécute les requêtes du fichier de création de triggers
        db.updateDBfile(data, "data/v1_triggers.sql", True)
    except Exception as e:
        # En cas d'erreur, on affiche un message
...
def database_delete(data):
    ...
    try:
        ...
        db.updateDBfile(data, "data/v1_deleteDB.sql", False)
    except Exception as e:
        # En cas d'erreur, on affiche un message
